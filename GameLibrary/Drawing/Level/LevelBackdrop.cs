...
namespace GameLibrary.Drawing
{
    public class LevelBackdrop
    {
        ...
        public void Load(ContentManager content, Vector2 roomDimensions, RoomThemeEnum theme, RoomTypeEnum type, string backgroundFile)
        {
            this.roomDimensions = new Point((int)roomDimensions.X, (int)roomDimensions.Y);

            if (type == RoomTypeEnum.Rotating)
            {
        ...
        private void LoadType(ContentManager content, RoomThemeEnum roomTheme, string backgroundFile)
        {
